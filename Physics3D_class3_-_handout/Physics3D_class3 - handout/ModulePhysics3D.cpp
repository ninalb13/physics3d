...
bool ModulePhysics3D::CleanUp()
{
	...
	for (int i = 0; i < collision_Shapes.count(); i++)
	{
		btCollisionShape* delete_iterator;
		collision_Shapes.at(i, delete_iterator);
	...
	{
		PhysBody3D* delete_iterator;
		bodies.at(i, delete_iterator);
		delete delete_iterator;
	}
	bodies.clear();
	delete world;
